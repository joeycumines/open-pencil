...
export { Matrix as TransformMatrix }
...
export { setInstanceStructureChangeHandler } from './instances'
...
import { LAYOUT_AFFECTING_KEYS } from './constants'
...
export class SceneGraph {
  ...
  static TEXT_GLYPH_KEYS: ReadonlySet<string> = TEXT_GLYPH_KEYS
