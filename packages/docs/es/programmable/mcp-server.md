...
El endpoint `/health` retorna la `version` del servidor. La app lo verifica al conectarse y rechaza si las versiones no coinciden. Actualiza el paquete global:
