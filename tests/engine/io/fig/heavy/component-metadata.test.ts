...
const MATERIAL3_COMPONENT_METADATA_TIMEOUT_MS = HEAVY_TEST_TIMEOUT_MS * 3
const GOLD_PREVIEW_COMPONENT_METADATA_TIMEOUT_MS = HEAVY_TEST_TIMEOUT_MS * 2
...
heavy('fig component metadata import', () => {
  test(
    ...
    GOLD_PREVIEW_COMPONENT_METADATA_TIMEOUT_MS
  )
  ...
  test(
    ...
    MATERIAL3_COMPONENT_METADATA_TIMEOUT_MS
  )
})
